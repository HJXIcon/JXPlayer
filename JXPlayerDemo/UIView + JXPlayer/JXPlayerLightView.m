...
@interface JXPlayerLightView ()
@property (nonatomic, strong) NSTimer *timer;
@end

@implementation JXPlayerLightView
+ (instancetype)sharedLightView{
    JXPlayerLightView *lightView = [[JXPlayerLightView alloc] init];
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        
        {
            ...
            self.centerLightIV.image        = [UIImage imageNamed:[@"JXPlayer.bundle" stringByAppendingPathComponent:@"play_new_brightness_day"]];
...
- (void)layoutSubviews {
    ...
    self.transform = [JXPlayer getCurrentDeviceOrientation];
